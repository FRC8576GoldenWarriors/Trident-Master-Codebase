  ...
  public void periodic() {
    ...
    switch (wantedPosition) {
      ...
      case Rest:
        ...
        break;
      case FrontL1:
        PIDVoltage = PID.calculate(getThruBorePosition(), PivotConstants.ControlConstants.frontL1);
        FFVoltage =
            FF.calculate(
        ...
        break;
      case FrontL2:
        PIDVoltage = PID.calculate(getThruBorePosition(), PivotConstants.ControlConstants.frontL2);
        FFVoltage =
            FF.calculate(
        ...
        break;
      case FrontL3:
        PIDVoltage = PID.calculate(getThruBorePosition(), PivotConstants.ControlConstants.frontL3);
        FFVoltage =
            FF.calculate(
        ...
        break;
      case FrontL4:
        PIDVoltage = PID.calculate(getThruBorePosition(), PivotConstants.ControlConstants.frontL4);
        FFVoltage =
            FF.calculate(
      ...
      case BackL1:
        ...
        FFVoltage =
            FF.calculate(
                (PivotConstants.ControlConstants.backL1 + PivotConstants.ControlConstants.COMOffset)
                    * Math.PI
                    * 2,
                0.5);
        inputVoltage = PIDVoltage + FFVoltage;
      ...
      case BackL2:
        ...
        FFVoltage =
            FF.calculate(
                (PivotConstants.ControlConstants.backL2 + PivotConstants.ControlConstants.COMOffset)
                    * Math.PI
                    * 2,
                0.5);
        inputVoltage = PIDVoltage + FFVoltage;
      ...
      case BackL3:
        ...
        FFVoltage =
            FF.calculate(
                (PivotConstants.ControlConstants.backL3 + PivotConstants.ControlConstants.COMOffset)
                    * Math.PI
                    * 2,
                0.5);
        inputVoltage = PIDVoltage + FFVoltage;
      ...
      case BackL4:
        ...
        FFVoltage =
            FF.calculate(
                (PivotConstants.ControlConstants.backL4 + PivotConstants.ControlConstants.COMOffset)
                    * Math.PI
                    * 2,
                0.5);
        inputVoltage = PIDVoltage + FFVoltage;
      ...
      case StationIntake:
        ...
        break;
      case SetClimb:
        PIDVoltage = PID.calculate(getThruBorePosition(), PivotConstants.ControlConstants.setClimb);
        FFVoltage =
            FF.calculate(
        ...
        break;
      case ClimbUp:
        PIDVoltage = PID.calculate(getThruBorePosition(), PivotConstants.ControlConstants.climbUp);
        FFVoltage =
            FF.calculate(
