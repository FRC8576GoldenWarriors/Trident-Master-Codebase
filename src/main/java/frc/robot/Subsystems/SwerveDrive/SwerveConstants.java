...
public class SwerveConstants {
  ...
  public static double LEFT_FRONT_OFFSET =
  -0.244141;//0.269531; // -0.231934; // -0.175049; // -0.160156; // 0.330322;
  public static double RIGHT_FRONT_OFFSET =
  -0.087891;// 0.407227; // -0.091553; // 0.184326; // -0.299805; // 0.191406;
  public static double LEFT_BACK_OFFSET =
  0.131104;// -0.395508; // 0.129639; // -0.036865; // -0.039551; // -0.013428;
  public static double RIGHT_BACK_OFFSET =
  -0.139893;//-0.149902; // 0.34375; // 0.173584; // 0.175293; // 0.178955;
  ...
  public static boolean RIGHT_BACK_DRIVE_INVERTED = true;//false;
