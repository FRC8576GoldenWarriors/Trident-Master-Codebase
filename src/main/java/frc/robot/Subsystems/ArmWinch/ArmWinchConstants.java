...
public class ArmWinchConstants {
  ...
  public class ControlConstants {
    public static double kP = .64;//Start at .64. .32 and lower tested w/ threshold//0.0; // 16384;//8192.0; // 0.6; // 0.8;//0.5;//0.45;
    ...
    public static double frontL1 = 2000;
    public static double frontL2 = 2500;
    public static double frontL3 = 4300;
    public static double frontL4 = 6000;
    ...
    public static double testPosition = 300;
  }
}
